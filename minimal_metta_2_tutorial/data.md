...
+---------------------------------+---------+-----------------+-------------------------------+
:  init                           :  &1     :  ""             :  []                           :
:  'a'       -> descend('a')      :  &2     :  "a"            :  [radix(&1)]                  :
:  'p'       -> descend('p')      :  &4     :  "ap"           :  [ .. , radix(&2)]            :
:  'l'       -> fail('l')         :  &4     :  "apl"          :  [ .. , fail(1)]              :
:  backspace -> ascend(1)         :  &4     :  "ap"           :  [ .. , radix(&2)]            :
:  'p'       -> descend('p')      :  &5     :  "app"          :  [ .. , string(&4, 1)]        :
:  'l'       -> descend('l')      :  &7     :  "appl"         :  [ .. , radix(&5)]            :
:  'i'       -> descend('i')      :  &8     :  "appli"        :  [ .. , radix(&7)]            :
:  enter     -> descend_to_val()  :  &0     :  "application"  :  [ .. , string(&8, 6)]        :
+---------------------------------+---------+-----------------+-------------------------------+
